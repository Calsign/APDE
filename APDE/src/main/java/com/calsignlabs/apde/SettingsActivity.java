...
//		
//		((SwitchPreferenceCompat) findPreference("use_hardware_keyboard")).setOnPreferenceChangeListener(new CheckBoxPreference.OnPreferenceChangeListener() {
//			@Override
...
//				getPreferenceScreen().removePreference(findPreference("pref_vibrate"));
//		
//		final SwitchPreferenceCompat enableUndoRedo = (SwitchPreferenceCompat) findPreference("pref_key_undo_redo");
//		
...
//		}
//		
//		Preference previewChannel = findPreference("pref_about_preview_channel");
//		
...
//		}
//		
//		Preference sketchbookDrivePref = findPreference("pref_sketchbook_drive");
//		
...
//			final Preference sketchbookLocation = findPreference("pref_sketchbook_location");
//			
